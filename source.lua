...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/secretthingcool/Sirius/refs/heads/request/prompt.lua')
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/secretthingcool/Rayfield/refs/heads/main/icons.lua')
-- Variables
...
--if not useStudio then
--	task.spawn(loadWithTimeout, "https://raw.githubusercontent.com/secretthingcool/Sirius/refs/heads/request/boost.lua")
--end
